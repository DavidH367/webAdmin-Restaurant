import 'package:administraciongr/widgets/simple_app_bar.dart';
...
class _AllBlockedUsersScreenState extends State<AllBlockedUsersScreen> {
  ...
  Widget build(BuildContext context)
  {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text(
                        "Activar esta cuenta".toUpperCase(),
                        style: const TextStyle(
                          fontSize: 15,
                          color: Colors.white,
                          letterSpacing: 3,
    ...
    return Scaffold(
      appBar: SimpleAppBar(title: "Todos los usuarios bloqueados",),
      body: Center(
        child: Container(
