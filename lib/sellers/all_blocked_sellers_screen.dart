    ...
    return showDialog(
        ...
        builder: (BuildContext context)
        {
          return AlertDialog(
            ...
            content: const Text(
              "¿Seguro que desea habilitar la cuenta?",
              style: TextStyle(
                fontSize: 16,
                letterSpacing: 2,
              ),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text(
                        "Total Ganacias".toUpperCase() + " L " + allSellers!.docs[i].get("earnings").toString(),
                        style: const TextStyle(
                          fontSize: 15,
                          color: Colors.white,
                          letterSpacing: 3,
